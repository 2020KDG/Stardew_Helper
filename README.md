...
1. **설치형 버전 (추천)**: [📥 Stardew Helper_1.2.0_x64-setup.exe 다운로드](https://github.com/2020KDG/Stardew_Helper/releases/download/v1.2.0/Stardew.Helper_1.2.0_x64-setup.exe)
   - 다운로드 후 실행하여 마법사의 안내에 따라 설치를 진행합니다. (바탕화면 바로가기 추가 지원)
2. **무설치 버전 (Portable)**: [📥 StardewHelper_Portable.exe 다운로드](https://github.com/2020KDG/Stardew_Helper/releases/download/v1.2.0/StardewHelper_Portable.exe)
   - 설치 과정 없이 다운로드 후 바로 더블 클릭하여 사용할 수 있습니다.

3. **모드 설치를 권장합니다.** [📥 StardewHelperMod.zip 다운로드](https://github.com/2020KDG/Stardew_Helper/releases/download/v1.2.0/StardewHelperMod.zip)
